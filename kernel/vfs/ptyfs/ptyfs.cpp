...
static int64_t ptyfs_dir_inode_getdents(Inode *self, int64_t offset, struct dirent*, size_t count);
...
static int64_t ptyfs_dir_inode_getdents(Inode*, int64_t, struct dirent*, size_t)
{
